...
String newTime = Mobile.callTestCase(findTestCase('Common Test Case/TC_Add_Note'), [('AddTime') : AddTime], FailureHandling.STOP_ON_FAILURE)

Mobile.comment('new_Time =' + newTime)

Mobile.verifyElementExist(findTestObject('Object Repository/Pages/NotePage/ListID', [('text') : newTime]), GlobalVariable.G_Timeout)

Mobile.tap(findTestObject('Pages/NotePage/listID', [('text') : newTime]), 0)
